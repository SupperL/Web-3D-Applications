...
function CoalDescription() {
	$("button").click(function(){
		$("#CoalDescription").show();
        $("#spriteDescription").hide();
		$("#cokeDescription").hide();
		$("#pepperDescription").hide();
		
		$("#x3dModelTitle_Coal").show();
		$("#x3dModelTitle_coffee").hide();
		$("#x3dModelTitle_coke").hide();
		$("#x3dModelTitle_sprite").hide();
		$("#x3dModelTitle_pepper").hide();
		$("#x3dModelTitle_Apple").hide();

		$("#x3dCreationMethod_Coal").show();
		$("#x3dCreationMethod_coffee").hide();
...
function coffeeDescription() {
	$("button").click(function(){
		...
		$("#x3dModelTitle_Coal").hide();
		$("#x3dModelTitle_coffee").show();
		$("#x3dModelTitle_coke").hide();
		$("#x3dModelTitle_sprite").hide();
		$("#x3dModelTitle_pepper").hide();
		$("#x3dModelTitle_Apple").hide();

		$("#x3dCreationMethod_Coal").hide();
		$("#x3dCreationMethod_coffee").show();
		$("#x3dCreationMethod_coke").hide();
		$("#x3dCreationMethod_sprite").hide();
		$("#x3dCreationMethod_pepper").hide();
...
function AppleDescription() {
	$("button").click(function(){
		...
		$("#x3dModelTitle_Coal").hide();
		$("#x3dModelTitle_coffee").hide();
		$("#x3dModelTitle_Apple").show();
		$("#x3dModelTitle_coke").hide();
		$("#x3dModelTitle_sprite").hide();
		$("#x3dModelTitle_pepper").hide();

		$("#x3dCreationMethod_Coal").hide();
		$("#x3dCreationMethod_Apple").show();
		$("#x3dCreationMethod_coffee").hide();
		$("#x3dCreationMethod_coke").hide();
		$("#x3dCreationMethod_sprite").hide();
		$("#x3dCreationMethod_pepper").hide();
