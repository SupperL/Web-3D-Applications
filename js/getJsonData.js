...
$(document).ready(function(){
	...
	$.getJSON('./model/data.json', function(jsonObj) {
	   ...
	   $('.x3dCameraSubtitle').html('<p>' + jsonObj.pageTextData[8].CameraSubtitle + '<p');
	    ...
	    //Get the coke main text data
		$('#x3dModelTitle_Coal').html('<h2>' + jsonObj.pageTextData[9].x3dModelTitle + '<h2>');
		$('#title_Coal').html('<h2>' + jsonObj.pageTextData[9].title + '<h2>');
		$('#subTitle_Coal').html('<h3>' + jsonObj.pageTextData[9].subTitle + '</h3>');
		$('#description_Coal').html('<p>' + jsonObj.pageTextData[9].description + '</p>');

		$('#x3dModelTitle_coffee').html('<h2>' + jsonObj.pageTextData[10].x3dModelTitle + '<h2>');
		$('#title_coffee').html('<h2>' + jsonObj.pageTextData[10].title + '<h2>');
		$('#subTitle_coffee').html('<h3>' + jsonObj.pageTextData[10].subTitle + '</h3>');
		$('#description_coffee').html('<p>' + jsonObj.pageTextData[10].description + '</p>');
		
		
		$('#x3dModelTitle_Apple').html('<h2>' + jsonObj.pageTextData[11].x3dModelTitle + '<h2>');
		$('#title_coffee').html('<h2>' + jsonObj.pageTextData[10].title + '<h2>');
		$('#subTitle_coffee').html('<h3>' + jsonObj.pageTextData[10].subTitle + '</h3>');
		$('#description_coffee').html('<p>' + jsonObj.pageTextData[10].description + '</p>');
